...
const CHAPTERS = [
  { id: 'what-belongs-in-food-waste', number: '01', label: 'What Belongs in Food Waste', emoji: '🥦' },
  { id: 'why-food-waste-matters', number: '02', label: 'Why Food Waste Matters', emoji: '🌍' },
  { id: 'avoiding-food-waste-contamination', number: '03', label: 'Avoiding Contamination', emoji: '🚫' },
];

export default function FoodOrganicWasteScreen() {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.nav}>
        ...
        <Text style={styles.navTitle}>Food & Organic Waste</Text>
        <View style={{ width: 38 }} />
      </View>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}>
        ...
        <View style={styles.descBox}>
          <Text style={styles.descTitle}>Learn about Food & Organic Waste</Text>
...
const styles = StyleSheet.create({
  ...
  heroBox: { marginHorizontal: 20, marginTop: 8, borderRadius: 18, height: 160, backgroundColor: '#D4EDDA', justifyContent: 'center', alignItems: 'center' },
  ...
  thumb: { width: 52, height: 52, borderRadius: 12, backgroundColor: '#D4EDDA', justifyContent: 'center', alignItems: 'center', marginRight: 14 },
  info: { flex: 1 },
