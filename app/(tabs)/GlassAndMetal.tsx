...
const CHAPTERS = [
  ...
  },
  {
    ...
    number: '03',
    label: 'Foil & Small Metals',
    image: null,
  },
];

export default function GlassMetalScreen() {
  function handleStartLesson() {
    router.push(`/(tabs)/GlassAndMetalChapters?chapter=${CHAPTERS[0].id}` as any);
  }
    ...
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 120 }}>
        ...
        <View style={styles.heroBox}>
          {/* Replace with: <Image source={require('../../assets/images/glass-hero.png')} style={styles.heroImage} /> */}
        ...
        <View style={styles.descBox}>
          ...
          <Text style={styles.descSubtitle}>
            Explore your Grade 10 Biology topics with fun lessons, quizzes, and games.
          </Text>
        </View>
        ...
        <View style={styles.chapterList}>
          {CHAPTERS.map((ch, index) => (
            <TouchableOpacity
              ...
              activeOpacity={0.75}
              onPress={() => router.push(`/(tabs)/GlassAndMetalChapters?chapter=${ch.id}` as any)}
            >
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={styles.startBtn} onPress={handleStartLesson} activeOpacity={0.85}>
