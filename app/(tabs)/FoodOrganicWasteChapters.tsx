...
const CHAPTER_DATA: Record<string, ChapterData> = {
  'what-belongs-in-food-waste': {
    id: 'what-belongs-in-food-waste',
    navTitle: 'What Belongs in Food Waste',
    title: 'Understanding Paper Recycling Basics',
    subtitle: 'Learn what items belong in your food waste bin.',
    parts: [
      { number: '01', label: 'Fruit & Veg Scraps',        emoji: '🥦' },
      { number: '02', label: 'Cooked Food',               emoji: '🍲' },
      { number: '03', label: 'Tea Bags & Coffee Grounds', emoji: '☕' },
    ],
    quizzes: ['Part 01 Quiz', 'Part 02 Quiz', 'Part 03 Quiz'],
  },
  'why-food-waste-matters': {
    id: 'why-food-waste-matters',
    navTitle: 'Why Food Waste Matters',
    title: 'Understanding Paper Recycling Basics',
    subtitle: 'Learn why reducing food waste is important for the environment.',
    parts: [
      { number: '01', label: 'Methane & Landfill',     emoji: '🌡️' },
      { number: '02', label: 'Composting Process',     emoji: '🌱' },
      { number: '03', label: 'Environmental Benefits', emoji: '🌍' },
    ],
    quizzes: ['Part 01 Quiz', 'Part 02 Quiz', 'Part 03 Quiz'],
  },
  'avoiding-food-waste-contamination': {
    id: 'avoiding-food-waste-contamination',
    navTitle: 'Avoiding Food Waste Contamination',
    title: 'Understanding Paper Recycling Basics',
    subtitle: 'Learn how to avoid contaminating your food waste bin.',
    parts: [
      { number: '01', label: 'Keeping Food Out of Recycling', emoji: '♻️' },
      { number: '02', label: 'Bagging Food Waste',            emoji: '🛍️' },
      { number: '03', label: 'Common Mistakes',               emoji: '⚠️' },
    ],
    quizzes: ['Part 01 Quiz', 'Part 02 Quiz', 'Part 03 Quiz'],
  },
};
...
export default function FoodOrganicWasteChapters() {
  const { chapter } = useLocalSearchParams<{ chapter: string }>();
  const data = CHAPTER_DATA[chapter ?? ''] ?? CHAPTER_DATA['what-belongs-in-food-waste'];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.nav}>
        <TouchableOpacity onPress={() => router.push('/(tabs)/FoodOrganicWaste' as any)} style={styles.backBtn}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 120 }}>
        <View style={styles.heroBox}>
          <View style={styles.heroPlaceholder}>
            <Text style={styles.heroEmoji}>{data.id === 'what-belongs-in-food-waste' ? '🥦' : data.id === 'why-food-waste-matters' ? '🌍' : '🚫'}</Text>
          </View>
        </View>
