...
const CHAPTERS = [
  ...
  { id: 'accepted-items-by-postcode', number: '02', label: 'Accepted Items', emoji: '📮' },
  { id: 'collection-service-updates', number: '03', label: 'Collection Updates', emoji: '🚛' },
];
    ...
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}>
        ...
        <View style={styles.descBox}>
          <Text style={styles.descTitle}>Learn about Local Rules</Text>
...
const styles = StyleSheet.create({
  ...
  heroBox: { marginHorizontal: 20, marginTop: 8, borderRadius: 18, height: 160, backgroundColor: '#E8EAF6', justifyContent: 'center', alignItems: 'center' },
  ...
  thumb: { width: 52, height: 52, borderRadius: 12, backgroundColor: '#E8EAF6', justifyContent: 'center', alignItems: 'center', marginRight: 14 },
  info: { flex: 1 },
