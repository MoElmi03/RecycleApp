...
const CHAPTERS = [
  { id: 'paper-recycling-basics',      number: '01', label: 'Paper Recycling Basics',      image: null },
  { id: 'cardboard-rules',             number: '02', label: 'Cardboard Rules',             image: null },
  { id: 'composite-paper-packaging',   number: '03', label: 'Composite Paper Packaging',   image: null },
];
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.chapterList}>
          {CHAPTERS.map((ch, index) => (
            <TouchableOpacity key={ch.id} style={styles.chapterRow} activeOpacity={0.75}
              onPress={() => router.push(`/(tabs)/PaperCardboardChapters?chapter=${ch.id}` as any)}>
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={styles.startBtn} onPress={() => router.push(`/(tabs)/PaperCardboardChapters?chapter=${CHAPTERS[0].id}` as any)} activeOpacity={0.85}>
