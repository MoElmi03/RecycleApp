...
const CHAPTERS = [
  { id: 'coffee-cups-takeaway-packaging', number: '01', label: 'Coffee Cups & Takeaway', emoji: '☕' },
  { id: 'greasy-food-soiled-items', number: '02', label: 'Greasy & Soiled Items', emoji: '🍕' },
  { id: 'problem-plastics', number: '03', label: 'Problem Plastics', emoji: '🛍️' },
];

export default function CommonContaminantsScreen() {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.nav}>
        ...
        <Text style={styles.navTitle}>Common Contaminants</Text>
        <View style={{ width: 38 }} />
      </View>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}>
        ...
        <View style={styles.descBox}>
          <Text style={styles.descTitle}>Learn about Common Contaminants</Text>
...
const styles = StyleSheet.create({
  ...
  heroBox: { marginHorizontal: 20, marginTop: 8, borderRadius: 18, height: 160, backgroundColor: '#FDECEA', justifyContent: 'center', alignItems: 'center' },
  ...
  thumb: { width: 52, height: 52, borderRadius: 12, backgroundColor: '#FDECEA', justifyContent: 'center', alignItems: 'center', marginRight: 14 },
  info: { flex: 1 },
